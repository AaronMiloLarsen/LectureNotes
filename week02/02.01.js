...
// // for (let a = alphabet[0]; a < alphabet[25]; alphabet[0 + 1])
// //     console.log(${a});
...
************
    ...
    - Arrays contain what are known as iterable properties. Each property - or value - in an array, each contains
     it's own index (the first item in an array has an index of 0, and so on).
...
// object bracket notation / properry accessors
// console.log(fellowshipOfTheRing['members']['Gandalf']);
